...
const Products = () => {
  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-5 duration-700">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="space-y-6">
              <div className="space-y-3">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1 flex items-center gap-2"><Tags className="h-3 w-3" /> Product Name</label>
                <input
                  name="name"
                  type="text"
                  required
              ...
              <div className="space-y-3">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Product Story / Desc</label>
                <textarea
                  name="description"
                  required
                  rows="4"
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-3">
                  <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1 flex items-center gap-2"><DollarSign className="h-3 w-3" /> Retail Price</label>
                  <input
                    name="price"
                    type="number"
                    required
                ...
                <div className="space-y-3">
                  <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Target Gender</label>
                  <select
                    name="gender"
                    className="w-full rounded-2xl border-0 bg-slate-50 py-4 px-6 text-slate-900 font-bold ring-1 ring-inset ring-slate-100 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-orange-500 appearance-none"
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Stock Sizes</label>
                <div className="flex flex-wrap gap-3">
                  {['XS', 'S', 'M', 'L', 'XL', 'XXL'].map(size => (
                    <button
                      ...
                      className={`px-5 py-2.5 rounded-xl text-xs font-black ring-2 ring-inset transition-all duration-300 ${
               ...
               <div className="space-y-3">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Sync Category</label>
                <select
                  name="category"
                  className="w-full rounded-2xl border-0 bg-slate-50 py-4 px-6 text-slate-900 font-bold ring-1 ring-inset ring-slate-100 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-orange-500 appearance-none"
              ...
              <div className="space-y-3">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1 flex items-center gap-2"><Upload className="h-3 w-3" /> Visual Assets (Max 5)</label>
                <div className="relative">
                    <input
                    type="file"
                    multiple
                    className="w-full rounded-2xl border-0 bg-slate-50 py-4 px-6 text-slate-900 font-bold ring-1 ring-inset ring-slate-100 file:mr-4 file:py-1 file:px-4 file:rounded-lg file:border-0 file:text-[10px] file:font-black file:uppercase file:bg-orange-500 file:text-white hover:file:bg-orange-600 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-orange-500"
      ...
      {/* Inventory Table */}
      <div className="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm shadow-slate-100 p-2">
          ...
          <table className="w-full text-left text-sm text-slate-900">
            <thead className="bg-slate-50 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
              <tr>
                ...
                <th className="hidden sm:table-cell px-8 py-5 text-center">Identity</th>
